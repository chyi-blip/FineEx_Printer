...
public class Text extends BaseJPL {
    ...
    public boolean drawOut(int x, int y, String text,
                           int fontHeight) {
        return drawOut(x, y, text, fontHeight, false, false, false, false, TEXT_ENLARGE.x1, TEXT_ENLARGE.x1, JPL.ROTATE.ROTATE_0);
    }
    ...
    public boolean drawOut(int y, String text,
                           int fontHeight, boolean bold, ALIGN align) {
        return drawOut(calcTextStartPosition(align, fontHeight, TEXT_ENLARGE.x1.ordinal(), text), y, text, fontHeight, bold, false, false, false, TEXT_ENLARGE.x1, TEXT_ENLARGE.x1, JPL.ROTATE.ROTATE_0);
    }


    public boolean drawOut(int x, int y, String text,
                           int fontHeight, boolean bold, boolean reverse, boolean underLine, boolean deleteLine, TEXT_ENLARGE enlargeX, TEXT_ENLARGE enlargeY, ROTATE rotateAngle) {
        if (x < 0 || y < 0)
            return false;
    ...
    public int calcTextWidth(int font_width, String text) {
        int hz_count = 0;
        int ascii_count = 0;
    ...
    public int calcFontWidth(int font_height) {
        if (font_height < 20) {
            return 16;
    ...
    public int calcTextStartPosition(ALIGN align, int font_height, int enlargeX, String text) {
        if (align == ALIGN.LEFT)
            return 0;
    ...
    public boolean drawOut(ALIGN align, int y, String text,
                           int fontHeight, boolean bold, boolean reverse, boolean underLine, boolean deleteLine, TEXT_ENLARGE enlargeX, TEXT_ENLARGE enlargeY, ROTATE rotateAngle) {
